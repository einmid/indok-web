              ...
              <Grid container alignItems="center" spacing={10}>
                ...
                <Grid xs={12} sm={6} item>
                  ...
                  <Typography variant="body2">
                    ...
                    spontane venneturer. Det er en gyllen mulighet til å få en liten pause fra det travle bylivet.
                    Indøks egne Hyttestyre arrangerer flere forskjellige turer i løpet av året. Dette er en flott
                    mulighet til både å bli kjent med hyttene, området rundt hyttene, og å bli kjent med andre indøkere
                    på tvers av klassetrinnene. Hyttestyret har det daglige ansvaret for drift og utbedring av
                    Indøkhyttene, organisering av utleie og felles hytteturer. Du kan lese mer om Hyttestyret
            ...
            <Grid item>
              <Grid container alignItems="center" spacing={10} direction="row">
                <Grid item xs={12} sm={6}>
                  ...
                  <Divider component="br" />
                  <Typography variant="body2">
                    Med sine to etasjer, er Bjørnen og Oksen estimert til å romme 18 personer per hytte. Den generelle
                    standarden er tilnærmet lik et vanlig bolighus. Begge hyttene har innlagt strøm og vann. I første
                    etasje finner du to bad, hvorav ett med badstue, og tre soverom med tre til fire sengeplasser per
                    rom. I andre etasje ligger stue, kjøkken og et fjerde soverom med sengeplass til tre. Dette gir
                    totalt fjorten sengeplasser på hver hytte og ekstramadrasser til de resterende 4 det er estimert
                    med. Dyner og puter til 18 gjester ligger tilgjengelig, men laken og sengetøy må medbringes.
                    Kjøkkenet er utstyrt med det mest nødvendige av hvitevarer, i tillegg til kaffetrakter, vannkoker og
                    vaffeljern m.m. Basiskrydder og olje til steking skal også være tilgjengelig. På hyttene ligger det
                    et bredt utvalg brettspill, samt kortstokker. I stua står det anlegg med AUX-kabel.
                  </Typography>
                </Grid>
