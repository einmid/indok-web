        ...
        <Grid container justifyContent="space-between" alignItems="center" spacing={{ xs: 2, md: 10 }}>
          ...
          >
            ...
            <Typography sx={{ mt: 3, mb: 5, opacity: 0.72 }}>
              ...
              standarden er tilnærmet lik et vanlig bolighus.
            </Typography>
            <Typography sx={{ mt: 3, mb: 5, opacity: 0.72 }}>
              ...
              resterende 4 det er estimert med. Dyner og puter til 18 gjester ligger tilgjengelig, men laken og sengetøy
              må medbringes.
            </Typography>
            <Typography sx={{ mt: 3, mb: 5, opacity: 0.72 }}>
              ...
              bredt utvalg brettspill, samt kortstokker. I stua står det anlegg med AUX-kabel.
            </Typography>
          </Grid>
